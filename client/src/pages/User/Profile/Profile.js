...
import { updateUserProfile, changePassword, fetchUserProfile } from '../../../redux/user/userSlice';

const UserProfile = () => {
  const dispatch = useDispatch();
  const { profile, loading, error } = useSelector(state => state.user.userProfile);
            ...
            <div className="modal-content rounded-4" style={{ border: 'none', minWidth: 400 }}>
              ...
              <div className="modal-body pt-2 pb-4 px-4">
                <form onSubmit={handlePasswordSubmit}>
                  ...
                  <div className="mb-4">
                    <label className="form-label fw-semibold" htmlFor="confirmPassword">Xác nhận mật khẩu</label>
                    <div className="input-group">
                      <span className="input-group-text bg-white" style={{ borderRight: 0, borderColor: '#e5e7eb' }}>
                        <i className="fas fa-lock" style={{ color: '#bdbdbd' }}></i>
                      </span>
                  ...
                  <button type="submit" className="btn btn-dark w-100 rounded-pill py-2 fw-bold" style={{ fontSize: 17 }} disabled={loading}>
